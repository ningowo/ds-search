...
public class Doc implements org.apache.thrift.TBase<Doc, Doc._Fields>, java.io.Serializable, Cloneable, Comparable<Doc> {
  ...
  private static final org.apache.thrift.protocol.TField _INDEX_FIELD_DESC = new org.apache.thrift.protocol.TField("_index", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  private static final int ___INDEX_ISSET_ID = 0;
  ...
  public Doc set_index(int _index) {
    this._index = _index;
    set_indexIsSet(true);
    return this;
  }
  ...
  public void unset_index() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, ___INDEX_ISSET_ID);
  }

  /** Returns true if field _index is set (has been assigned a value) and false otherwise */
  public boolean isSet_index() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, ___INDEX_ISSET_ID);
  }

  public void set_indexIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, ___INDEX_ISSET_ID, value);
  }
  ...
  public Doc setContent(@org.apache.thrift.annotation.Nullable String content) {
    this.content = content;
    return this;
  }
  ...
  public boolean equals(Doc that) {
    ...
    boolean this_present__index = true;
    boolean that_present__index = true;
  ...
  public int compareTo(Doc other) {
    ...
    lastComparison = Boolean.compare(isSet_index(), other.isSet_index());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSet_id(), other.isSet_id());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_id()) {
